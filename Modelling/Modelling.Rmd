...
ggplot(Rdata, aes(x= before_lockdown_r)) + geom_boxplot() + 
  labs(x= "Reproduction Rate", title= "Distribution of R before Lockdown",
       subtitle= "R calculated from the 28 days before lockdown in 33 countries") 
ggplot(Rdata, aes(x= during_lockdown_r)) + geom_boxplot() + 
  labs(x= "Reproduction Rate", title= "Distribution of R from peak cases day",
       subtitle= "R calculated from the 28 days after the peak cases day in lockdown in 43 countries") 
ggplot(Rdata, aes(x= post_lockdown_r)) + geom_boxplot() + 
  labs(x= "Reproduction Rate", title= "Distribution of R after Lockdown",
       subtitle= "R calculated from the 7 days after lockdown in 43 countries") 
dev.off()
```
