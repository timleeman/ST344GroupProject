...
knitr::opts_chunk$set(echo = TRUE, warnings = FALSE, fig.height = 10, fig.width= 15,fig.align='center')
```
...
```{r include = FALSE}
theme_replace(axis.title = element_text(size = 24), plot.title = element_text(size = 24), legend.text = element_text(size = 20), axis.text = element_text(size = 14))
```
...
```{r exploring_Rdata, errors=FALSE, message=FALSE, warning=FALSE, fig.height=7, fig.width=10}
...
### Adding average temp for use as a possible explanatory variable & creating datafram with the relevant explanatory variables for modelling
```{r }
