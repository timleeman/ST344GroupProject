install.packages("dplyr", "tidyverse", "remotes", "lubridate", "readxl", "rio")
...
library(rio)
library(tidycovid19)
auravisionData <- read_csv("https://raw.github.com/timleeman/ST344GroupProject/blob/main/Data/AuraVisionCleaned.csv")
